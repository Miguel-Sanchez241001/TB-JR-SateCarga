...
public enum Bnsate13RptaMefTemp {
    ...
    B13_NUM_TARJETA_AUT("B13_NUM_TARJETA_AUT", 70, 90, true),
    B13_FEC_INICIO_AUT("B13_FEC_INICIO_AUT", 90, 100, true),
    B13_FEC_FIN_AUT("B13_FEC_FIN_AUT", 100, 110, true),
    B13_IMPORTE("B13_IMPORTE", 110, 120, true),
    B13_SEC_OPERACION_REF("B13_SEC_OPERACION_REF", 120, 130, true),
    B13_FECHA_REGISTRO("B13_FECHA_REGISTRO", 130, 140, true);
